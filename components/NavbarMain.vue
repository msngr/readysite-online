            ...
            >
                <li v-for="link in links">
                    ...
                    >
                        <!-- Whatsapp SVG -->
                        <svg
                            v-if="link.to === 'tel:+49060412299900'"
                            class="w-6 mr-1"
                            viewBox="0 0
                                24 24"
                        >
                        ...
                        {{ link.name }}
                        <!-- Blog/Facebook Divider -->
                        <span
                            v-if="link.name === 'Blog'"
                            class="group-hover:!text-black transition cursor-default ml-1.5"
                        >
                            |
                        </span>
                    </NuxtLink>
                    ...
                    >
                        <svg
                            v-if="link.name === 'Blog'"
                            class="w-6 pl-1.5 box-content hover:scale-110 transition"
                            viewBox="0 0
                                24 24"
                        >
                            <path
